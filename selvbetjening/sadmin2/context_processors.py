...
sadmin2_menu = (
    {'name': u'Arrangementer',
     'items': (
         {'name': u'Administrer', 'url': 'sadmin2:events_list'},
         {'name': u'Registrer betalinger', 'url': 'sadmin:events_event_register_payment'},
     )},
    {'name': u'Brugere',
     'items': (
         {'name': u'Administrer', 'url': 'sadmin:auth_user_changelist'},
...
sadmin2_menu_event = (
    {'items': (
        ...
        {'id': 'economics', 'name': u'Økonomi', 'url': 'sadmin2:events_attendees_list', 'icon': 'money'},
...
def sadmin2_navigation(request):
    return sadmin2_menu_manifest
