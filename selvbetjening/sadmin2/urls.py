...
urlpatterns = patterns(
    ...
    url(r'^events/(?P<event_pk>[0-9]+)/attendees/(?P<attendee_pk>[0-9]+)/log/$',
        'views.event.event_attendee_log',
        name='event_attendee_log'),
    ...
    url(r'^events/(?P<event_pk>[0-9]+)/copy/$',
        'views.event.event_copy',
        name='event_copy'),
