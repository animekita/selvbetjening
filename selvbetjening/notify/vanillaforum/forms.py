...
class SettingsForm(forms.ModelForm):
    ...
    layout = Layout(
        Fieldset(_(u'Notify me when people comment on my discussions'),
                       Row('notify_comment_discussions_popup',
                           'notify_comment_discussions_email')),

        #Fieldset(_(u'Notify me when people mention me in discussion titles'),
                       #Row('notify_mentioned_in_titles_popup',
                           #'notify_mentioned_in_titles_email')),

        #Fieldset(_(u'Notify me when people mention me in comments'),
                       #Row('notify_mentioned_in_comments_popup',
                           #'notify_mentioned_in_comments_email')),

        Fieldset(_(u'Notify me when people comment on my bookmarked discussions'),
                       Row('notify_comment_bookmarked_popup',
                           'notify_comment_bookmarked_email')),

        Fieldset(_(u'Notify me when people start new discussions'),
                       'notify_new_discussion_email'),

        Fieldset(_(u'Notify me of private messages'),
                       Row('notify_private_message_popup',
                           'notify_private_message_email')),

        Fieldset(_(u'Notify me when I am added to private conversations'),
