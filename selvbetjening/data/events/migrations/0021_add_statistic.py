...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_optiongroup', 'public_statistic', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OptionGroup.public_statistic'
        db.delete_column('events_optiongroup', 'public_statistic')
