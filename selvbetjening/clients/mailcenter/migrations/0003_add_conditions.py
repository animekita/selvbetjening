...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mailcenter_condition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('specification', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conditions', to=orm['mailcenter.EmailSpecification'])),
            ('negate_condition', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('comparator', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('argument', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('mailcenter', ['Condition'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('mailcenter_condition')
