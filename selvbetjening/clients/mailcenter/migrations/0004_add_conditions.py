...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mailcenter_attendconditions', (
            ...
            ('attends_event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.Event'], null=True, blank=True)),
            ('attends_selection_comparator', self.gf('django.db.models.fields.CharField')(default='someof', max_length=12)),
            ('attends_status', self.gf('selvbetjening.core.models.ListField')(blank=True)),
        ))
    ...
    models = {
        ...
        'mailcenter.attendconditions': {
            ...
            'attends_status': ('selvbetjening.core.models.ListField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
