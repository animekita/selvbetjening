...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Mail'
        db.create_table('mailcenter_mail', (
        ...
        db.send_create_signal('mailcenter', ['Mail'])

        # Adding M2M table for field recipients on 'Mail'
        db.create_table('mailcenter_mail_recipients', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mail', models.ForeignKey(orm['mailcenter.mail'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('mailcenter_mail_recipients', ['mail_id', 'user_id'])


    def backwards(self, orm):
        
        # Deleting model 'Mail'
        db.delete_table('mailcenter_mail')

        # Removing M2M table for field recipients on 'Mail'
        db.delete_table('mailcenter_mail_recipients')
