...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageLog.message_body_html'
        db.add_column('mailer_messagelog', 'message_body_html', orm['mailer.messagelog:message_body_html'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'MessageLog.message_body_html'
        db.delete_column('mailer_messagelog', 'message_body_html')
