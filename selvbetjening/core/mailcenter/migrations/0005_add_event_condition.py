...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventConditions'
        db.create_table('mailcenter_eventconditions', (
        ...
        db.send_create_signal('mailcenter', ['EventConditions'])


    def backwards(self, orm):
        
        # Deleting model 'EventConditions'
        db.delete_table('mailcenter_eventconditions')
