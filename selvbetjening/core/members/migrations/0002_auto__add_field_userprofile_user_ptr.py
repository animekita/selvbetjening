...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_ptr'
        db.add_column(u'members_userprofile', 'user_ptr',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_ptr', null=True, db_column='user_ptr_id', default=None, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_ptr'
        db.delete_column(u'members_userprofile', 'user_ptr_id')
    ...
    models = {
        ...
        u'members.userprofile': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user'", 'unique': 'True', 'primary_key': 'True', 'db_column': "'user_id'", 'to': u"orm['auth.User']"}),
            'user_ptr': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_ptr'", 'null': 'True', 'db_column': "'user_ptr_id'", 'default': 'None', 'to': u"orm['auth.User']", 'unique': 'True'})
        },
