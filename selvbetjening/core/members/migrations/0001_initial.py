...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'members_userwebsite', (
        ...
        db.send_create_signal(u'members', ['UserWebsite'])
        ...
        db.create_table(u'members_userprofile', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True, primary_key=True, db_column='user_id')),
        ...
        db.create_table(u'members_userlocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'members', ['UserLocation'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'members_userwebsite')
        ...
        db.delete_table(u'members_userlocation')
    ...
    models = {
        ...
        u'members.userprofile': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'unique': 'True', 'primary_key': 'True', 'db_column': "'user_id'"})
        },
