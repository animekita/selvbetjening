...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for com in orm['members.UserCommunication'].objects.all():

            user = com.user

            if com.method == 'skype':
                user.skype = com.identification
            elif com.method == 'jabber':
                user.jabber = com.identification
            elif com.method == 'msn':
                user.msn = com.identification
            else:
                raise ValueError
