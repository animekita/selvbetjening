...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'members_userprofile', 'skype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.jabber'
        db.add_column(u'members_userprofile', 'jabber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.msn'
        db.add_column(u'members_userprofile', 'msn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'members_userprofile', 'skype')

        # Deleting field 'UserProfile.jabber'
        db.delete_column(u'members_userprofile', 'jabber')

        # Deleting field 'UserProfile.msn'
        db.delete_column(u'members_userprofile', 'msn')
