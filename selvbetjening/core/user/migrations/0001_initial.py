...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'user', ['SUser'])

        # Adding M2M table for field groups on 'SUser'
        m2m_table_name = db.shorten_name(u'user_suser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('suser', models.ForeignKey(orm[u'user.suser'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['suser_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'SUser'
        m2m_table_name = db.shorten_name(u'user_suser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('suser', models.ForeignKey(orm[u'user.suser'], null=False)),
            ('permission', models.ForeignKey(orm[u'auth.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['suser_id', 'permission_id'])


    def backwards(self, orm):
        # Deleting model 'SUser'
        db.delete_table(u'user_suser')

        # Removing M2M table for field groups on 'SUser'
        db.delete_table(db.shorten_name(u'user_suser_groups'))

        # Removing M2M table for field user_permissions on 'SUser'
        db.delete_table(db.shorten_name(u'user_suser_user_permissions'))
