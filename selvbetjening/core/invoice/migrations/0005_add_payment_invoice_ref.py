...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('invoice_payment', 'invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoice.Invoice'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Payment.invoice'
        db.delete_column('invoice_payment', 'invoice_id')
