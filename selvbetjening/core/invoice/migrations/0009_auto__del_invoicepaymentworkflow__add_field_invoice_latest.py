...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('invoice_invoice', 'latest',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='latestrevision', null=True, to=orm['invoice.InvoiceRevision']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('invoice_invoicepaymentworkflow', (
            ('notification_email', self.gf('django.db.models.fields.TextField')()),
            ('notification_email_subject', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.delete_column('invoice_invoice', 'latest_id')
    ...
    models = {
        ...
        'invoice.invoice': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'latestrevision'", 'null': 'True', 'to': "orm['invoice.InvoiceRevision']"}),
