...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Log'
        db.create_table(u'logging_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reverse_log', null=True, to=orm['user.SUser'])),
            ...
            ('related_attendee', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='log', null=True, on_delete=models.SET_NULL, to=orm['events.Attend'])),
            ('related_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='log', null=True, on_delete=models.SET_NULL, to=orm['user.SUser'])),
            ('related_email', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='log', null=True, on_delete=models.SET_NULL, to=orm['mailqueue.MailerMessage'])),
        ))
        db.send_create_signal('logging', ['Log'])


    def backwards(self, orm):
        # Deleting model 'Log'
        db.delete_table(u'logging_log')
    ...
    models = {
        ...
        'logging.log': {
            ...
            'related_attendee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'log'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['events.Attend']"}),
            'related_email': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'log'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['mailqueue.MailerMessage']"}),
            'related_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'log'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['user.SUser']"}),
            'request_ip': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'request_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reverse_log'", 'null': 'True', 'to': u"orm['user.SUser']"}),
