...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Option.notify_on_selection'
        db.add_column(u'events_option', 'notify_on_selection',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notify_option_on_selection', null=True, to=orm['mailcenter.EmailSpecification']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.notify_on_selection'
        db.delete_column(u'events_option', 'notify_on_selection_id')
