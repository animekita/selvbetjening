...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.tagline'
        db.add_column(u'events_event', 'tagline',
        ...
        # Adding field 'Event.location_link'
        db.add_column(u'events_event', 'location_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.tagline'
        db.delete_column(u'events_event', 'tagline')

        # Deleting field 'Event.location'
        db.delete_column(u'events_event', 'location')

        # Deleting field 'Event.location_link'
        db.delete_column(u'events_event', 'location_link')
