...
class Migration(DataMigration):
    """
    Update suboption price since we have moved from an absolute to a relative pricing model
    """
    ...
    def forwards(self, orm):
        ...
        for suboption in orm.SubOption.objects.all():

            if suboption.price is not None:
                suboption.price = suboption.price - suboption.option.price
                suboption.save()
