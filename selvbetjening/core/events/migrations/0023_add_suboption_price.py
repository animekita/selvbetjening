...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubOption.price'
        db.add_column('events_suboption', 'price', self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubOption.price'
        db.delete_column('events_suboption', 'price')
