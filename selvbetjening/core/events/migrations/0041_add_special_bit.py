...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptionGroup.is_special'
        db.add_column(u'events_optiongroup', 'is_special',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptionGroup.is_special'
        db.delete_column(u'events_optiongroup', 'is_special')
