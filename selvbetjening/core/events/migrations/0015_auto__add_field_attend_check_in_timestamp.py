...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attend.check_in_timestamp'
        db.add_column(u'events_attend', 'check_in_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attend.check_in_timestamp'
        db.delete_column(u'events_attend', 'check_in_timestamp')
