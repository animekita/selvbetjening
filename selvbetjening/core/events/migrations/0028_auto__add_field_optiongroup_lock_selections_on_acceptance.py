...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_optiongroup', 'lock_selections_on_acceptance', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OptionGroup.lock_selections_on_acceptance'
        db.delete_column('events_optiongroup', 'lock_selections_on_acceptance')
