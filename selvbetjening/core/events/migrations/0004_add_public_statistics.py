...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Option.in_scope_view_public'
        db.add_column(u'events_option', 'in_scope_view_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.in_scope_view_public'
        db.delete_column(u'events_option', 'in_scope_view_public')
