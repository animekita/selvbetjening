...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # the default settings for options are "disabled", however legacy systems expect this to be enabled

        for option in orm['events.option'].objects.all():

            option.in_scope_view_registration = True
            option.in_scope_view_manage = True
            option.in_scope_view_user_invoice = True
            option.in_scope_view_system_invoice = True

            option.in_scope_edit_registration = True
            option.in_scope_edit_manage_waiting = True
            option.in_scope_edit_manage_accepted = False
            option.in_scope_edit_manage_attended = False
