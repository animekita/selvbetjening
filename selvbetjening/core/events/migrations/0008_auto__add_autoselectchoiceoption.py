...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AutoSelectChoiceOption'
        db.create_table(u'events_autoselectchoiceoption', (
            (u'option_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Option'], unique=True, primary_key=True)),
            ('auto_select_suboption', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.SubOption'], null=True, blank=True)),
        ))
        db.send_create_signal('events', ['AutoSelectChoiceOption'])


    def backwards(self, orm):
        # Deleting model 'AutoSelectChoiceOption'
        db.delete_table(u'events_autoselectchoiceoption')
