...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttendeeComment.check_in_announce'
        db.add_column(u'events_attendeecomment', 'check_in_announce',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttendeeComment.check_in_announce'
        db.delete_column(u'events_attendeecomment', 'check_in_announce')
