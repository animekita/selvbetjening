...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.tagline'
        db.alter_column(u'events_event', 'tagline', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Event.tagline'
        db.alter_column(u'events_event', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=255))
