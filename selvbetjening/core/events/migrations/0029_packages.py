...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('events_optiongroup', 'package_solution', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'OptionGroup.package_price'
        db.add_column('events_optiongroup', 'package_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OptionGroup.package_solution'
        db.delete_column('events_optiongroup', 'package_solution')

        # Deleting field 'OptionGroup.package_price'
        db.delete_column('events_optiongroup', 'package_price')
