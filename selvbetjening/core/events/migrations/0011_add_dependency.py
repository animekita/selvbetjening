...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Option.depends_on'
        db.add_column(u'events_option', 'depends_on',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.Option'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Option.depends_on'
        db.delete_column(u'events_option', 'depends_on_id')
