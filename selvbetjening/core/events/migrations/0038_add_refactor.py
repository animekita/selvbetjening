...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Option.auto_select'
        db.delete_column(u'events_option', 'auto_select')

        # Adding field 'Option.selected_by_default'
        db.add_column(u'events_option', 'selected_by_default',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Option.auto_select'
        db.add_column(u'events_option', 'auto_select',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Option.selected_by_default'
        db.delete_column(u'events_option', 'selected_by_default')
