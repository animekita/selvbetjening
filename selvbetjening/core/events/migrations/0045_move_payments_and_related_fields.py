...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attend.price'
        db.add_column(u'events_attend', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Attend.paid'
        db.add_column(u'events_attend', 'paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attend.price'
        db.delete_column(u'events_attend', 'price')

        # Deleting field 'Attend.paid'
        db.delete_column(u'events_attend', 'paid')
