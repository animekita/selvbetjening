...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.attendance_price'
        db.add_column(u'events_event', 'attendance_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.attendance_price'
        db.delete_column(u'events_event', 'attendance_price')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'attendance_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '6', 'decimal_places': '2'}),
