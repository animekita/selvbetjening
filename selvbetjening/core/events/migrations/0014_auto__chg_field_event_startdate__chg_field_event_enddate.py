...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'startdate', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 23, 0, 0)))

        # Changing field 'Event.enddate'
        db.alter_column(u'events_event', 'enddate', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 23, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Event.startdate'
        db.alter_column(u'events_event', 'startdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.enddate'
        db.alter_column(u'events_event', 'enddate', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'events.attendeecomment': {
            ...
            'check_in_announce': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'events.option': {
            ...
            'depends_on': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['events.Option']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'notify_on_selection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'notify_option_on_selection'", 'null': 'True', 'to': u"orm['mailcenter.EmailSpecification']"}),
