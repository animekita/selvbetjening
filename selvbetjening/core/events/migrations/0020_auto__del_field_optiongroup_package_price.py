...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OptionGroup.package_price'
        db.delete_column(u'events_optiongroup', 'package_price')


    def backwards(self, orm):
        # Adding field 'OptionGroup.package_price'
        db.add_column(u'events_optiongroup', 'package_price',
